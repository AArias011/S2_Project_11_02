...
*/
//This sets the current date on the rendered page.
var thisDate = new Date();
//This code has a variable of dateString with the local conventions with the variable thisDate.
var dateString = thisDate.toLocaleString();
//This code has a variable od dateHTML with a certain text string.
var dateHTML = "<h2>" + dateString + "</h2>";
//This code has a variable of thisDay with the getDay method that affects the thisDate variable.
var thisDay = thisDate.getDay();
//This code has a variable of eventHTML with the function getEvent with parameter value of thisDay.
var eventHTML = getEvent(thisDay);
//This code has method of getElementById with the variable of unionToday, also another method insertAdjacentHTML with the variables of dateHTML plus eventHTML.
